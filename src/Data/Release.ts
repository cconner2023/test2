...
export const ReleaseNotes: ReleaseNoteTypes[] = [
    { version: '2.6.9', type: 'added', text: 'sub-tasks in calendar events. Custom cluster PCC/PCIs so you can apply sub-tasks to an event or a pre-defined packing list' },
