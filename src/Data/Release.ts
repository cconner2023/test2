...
export const ReleaseNotes: ReleaseNoteTypes[] = [
    ...
    { version: '2.7.0', type: 'changed', sectionId: 'event-subtasks', text: 'sub-tasks in calendar events. Custom cluster PCC/PCIs so you can apply sub-tasks to an event or a pre-defined packing list' },
