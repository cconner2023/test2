...
export function useNavigation() {
    ...
    const store = useNavigationStore(useShallow((s) => ({
        ...
        setShowUserGuideDrawer: s.setShowUserGuideDrawer,
        ...
        setShowTC3Drawer: s.setShowTC3Drawer,
