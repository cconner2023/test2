...
export const BURN_REGIONS: BurnRegion[] = [
    ...
    { id: 'l-arm-front',  label: 'L Arm (front)',       view: 'front', adultPct: 3.5,  pedPct: 3.5 },
    { id: 'r-arm-front',  label: 'R Arm (front)',       view: 'front', adultPct: 3.5,  pedPct: 3.5 },
    { id: 'l-hand-front', label: 'L Hand (front)',      view: 'front', adultPct: 1,    pedPct: 1 },
    { id: 'r-hand-front', label: 'R Hand (front)',      view: 'front', adultPct: 1,    pedPct: 1 },
    ...
    { id: 'l-arm-back',   label: 'L Arm (back)',        view: 'back',  adultPct: 3.5,  pedPct: 3.5 },
    { id: 'r-arm-back',   label: 'R Arm (back)',        view: 'back',  adultPct: 3.5,  pedPct: 3.5 },
    { id: 'l-hand-back',  label: 'L Hand (back)',       view: 'back',  adultPct: 1,    pedPct: 1 },
    { id: 'r-hand-back',  label: 'R Hand (back)',       view: 'back',  adultPct: 1,    pedPct: 1 },
    { id: 'l-buttock',    label: 'L Buttock',           view: 'back',  adultPct: 1,    pedPct: 1 },
    { id: 'r-buttock',    label: 'R Buttock',           view: 'back',  adultPct: 1,    pedPct: 1 },
