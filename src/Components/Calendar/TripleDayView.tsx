              ...
              {col.positioned.map(({ event, top, height, col: lane, totalCols }) => {
                ...
                return (
                  <div
                    ...
                    className={`absolute rounded-lg overflow-hidden flex items-stretch gap-1 text-left select-none cursor-pointer transition-all duration-200 active:scale-[0.98] bg-primary/5 ${sm.opacity}`}
                    style={{
                      top,
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 px-1 py-0.5 relative">
                      ...
                      <p className={`text-[9pt] font-normal truncate leading-tight text-primary ${sm.strikethrough ? 'line-through opacity-70' : ''}`}>
                        {event.title}
                      </p>
                      {height > 32 && (
                        <p className="text-[8pt] text-tertiary truncate">
