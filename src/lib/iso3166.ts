...
export const ISO_COUNTRIES: Iso3166Country[] = [
  ...
  },
  {
    ...
    name: 'Egypt',
    subdivisions: [
      { code: 'C', name: 'Cairo' }, { code: 'GZ', name: 'Giza' },
      { code: 'ALX', name: 'Alexandria' }, { code: 'DK', name: 'Dakahlia' },
      { code: 'BH', name: 'Beheira' }, { code: 'FYM', name: 'Faiyum' },
      { code: 'GH', name: 'Gharbia' }, { code: 'IS', name: 'Ismailia' },
      { code: 'MN', name: 'Minya' }, { code: 'MNF', name: 'Monufia' },
      { code: 'KB', name: 'Qalyubia' }, { code: 'LX', name: 'Luxor' },
      { code: 'WAD', name: 'New Valley' }, { code: 'SUZ', name: 'Suez' },
      { code: 'SHR', name: 'Sharqia' }, { code: 'ASN', name: 'Aswan' },
      { code: 'AST', name: 'Asyut' }, { code: 'BNS', name: 'Beni Suef' },
      { code: 'PTS', name: 'Port Said' }, { code: 'DT', name: 'Damietta' },
      { code: 'JS', name: 'South Sinai' }, { code: 'KFS', name: 'Kafr el-Sheikh' },
      { code: 'MT', name: 'Matrouh' }, { code: 'KN', name: 'Qena' },
      { code: 'SIN', name: 'North Sinai' }, { code: 'SHG', name: 'Sohag' },
  ...
  },
  {
    ...
    name: 'Syria',
    subdivisions: [
      { code: 'DI', name: 'Damascus' }, { code: 'RD', name: 'Rif Dimashq' },
      { code: 'HL', name: 'Aleppo' }, { code: 'HM', name: 'Hama' },
      { code: 'HI', name: 'Homs' }, { code: 'LA', name: 'Latakia' },
      { code: 'TA', name: 'Tartus' }, { code: 'ID', name: 'Idlib' },
      { code: 'HA', name: 'Al-Hasakah' }, { code: 'RA', name: 'Ar-Raqqah' },
      { code: 'DY', name: 'Deir ez-Zor' }, { code: 'DR', name: 'Daraa' },
      { code: 'SU', name: 'As-Suwayda' }, { code: 'QU', name: 'Quneitra' },
    ],
  },
  {
    code: 'RO',
