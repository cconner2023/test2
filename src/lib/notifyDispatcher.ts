...
export function fireNotification(payload: { user_id?: string; user_ids?: string[]; title?: string; body?: string; url?: string; type?: string; name?: string | null; email?: string | null; clinic_id?: string | null; author_id?: string }): void {
